...
def create_db():
    ...
    questions = [
        ...
        {
            "question_text": "Qual a diferença entre um passivo da rede interna e um passivo de rede externa?",
            "options": [
                ("Nenhuma, a função dos dois é dividir o sinal", "A"),
                ("O de Rede Externa suporta umidade e permite passagem de AC", "B"),
                ("O de Rede externa permite que se tenha o sinal em parte desiguais", "C"),
                ("O de Rede interna pode ser utilizado para acoplar sinais", "D")
            ],
            "correct_answer": "B",
            "image": None
        },
